        ...
        <div className="container">
          <div className="contact-grid">
            ...
            <div className="contact-info-wrapper">
              ...
              <p className="contact-info-subtitle">Reach out to us directly</p>
              ...
              <div className="contact-info-cards">
                <div className="info-card">
                  ...
                  <div className="info-content">
                    ...
                    <a href="mailto:support@realestate.com" className="info-value">support@realestate.com</a>
                    <a href="mailto:sales@realestate.com" className="info-value">sales@realestate.com</a>
                  </div>
                </div>
                ...
                <div className="info-card">
                  ...
                  <div className="info-content">
                    ...
                    <a href="tel:+911234567890" className="info-value">+91 12345 67890</a>
                  </div>
                </div>
                ...
                <div className="info-card">
                  ...
                  <div className="info-content">
                    ...
                    <p className="info-value">123 Real Estate Avenue</p>
                    <p className="info-value">Mumbai, Maharashtra 400001</p>
                  </div>
                </div>
                ...
                <div className="info-card">
                  ...
                  <div className="info-content">
                    ...
                    <p className="info-value">Monday - Friday: 9 AM - 6 PM</p>
                    <p className="info-value">Saturday: 10 AM - 4 PM</p>
