...
function staggerDates(posts, options = {}) {
  const { baseDate = '2022-06-16', gapMonths = 4 } = options;
  ...
  return sortedPosts.map((post, index) => {
    ...
    if (index === 0) {
      // Keep the base date for first post
...
export const posts = staggerDates(rawPosts);
